...
class PsSeoPack extends \Opencart\System\Engine\Controller
{
     ...
     */
    const EXTENSION_DOC = 'https://github.com/playfulsparkle/oc4_seo_pack.git';
    ...
    public function index(): void
    {
        ...
        $data['module_ps_seo_pack_store_name'] = isset($config['module_ps_seo_pack_store_name']) ? (array) $config['module_ps_seo_pack_store_name'] : [];
        $data['module_ps_seo_pack_store_owner'] = isset($config['module_ps_seo_pack_store_owner']) ? (array) $config['module_ps_seo_pack_store_owner'] : [];
        $data['module_ps_seo_pack_store_description'] = isset($config['module_ps_seo_pack_store_description']) ? (array) $config['module_ps_seo_pack_store_description'] : [];
        $data['module_ps_seo_pack_postal_address'] = isset($config['module_ps_seo_pack_postal_address']) ? (array) $config['module_ps_seo_pack_postal_address'] : [];
        $data['module_ps_seo_pack_location_address'] = isset($config['module_ps_seo_pack_location_address']) ? (array) $config['module_ps_seo_pack_location_address'] : [];
        $data['module_ps_seo_pack_alternate_store_name'] = isset($config['module_ps_seo_pack_alternate_store_name']) ? (array) $config['module_ps_seo_pack_alternate_store_name'] : [];
        $data['module_ps_seo_pack_same_as'] = isset($config['module_ps_seo_pack_same_as']) ? (array) $config['module_ps_seo_pack_same_as'] : [];
        $data['module_ps_seo_pack_price_range'] = isset($config['module_ps_seo_pack_price_range']) ? $config['module_ps_seo_pack_price_range'] : '';
        $data['module_ps_seo_pack_geo_coordinates'] = isset($config['module_ps_seo_pack_geo_coordinates']) ? (array) $config['module_ps_seo_pack_geo_coordinates'] : [];
        $data['module_ps_seo_pack_opening_hour'] = isset($config['module_ps_seo_pack_opening_hour']) ? (array) $config['module_ps_seo_pack_opening_hour'] : [];
        $data['module_ps_seo_pack_contact_point'] = isset($config['module_ps_seo_pack_contact_point']) ? (array) $config['module_ps_seo_pack_contact_point'] : [];
        $data['module_ps_seo_pack_return_policy'] = isset($config['module_ps_seo_pack_return_policy']) ? (bool) $config['module_ps_seo_pack_return_policy'] : false;
        $data['module_ps_seo_pack_return_policies'] = isset($config['module_ps_seo_pack_return_policies']) ? (array) $config['module_ps_seo_pack_return_policies'] : [];
        $data['module_ps_seo_pack_sdm_stock_status'] = isset($config['module_ps_seo_pack_sdm_stock_status']) ? (bool) $config['module_ps_seo_pack_sdm_stock_status'] : false;
        $data['module_ps_seo_pack_sdm_stock_status_assoc'] = isset($config['module_ps_seo_pack_sdm_stock_status_assoc']) ? (array) $config['module_ps_seo_pack_sdm_stock_status_assoc'] : [];
        $data['module_ps_seo_pack_shipping_rate'] = isset($config['module_ps_seo_pack_shipping_rate']) ? (bool) $config['module_ps_seo_pack_shipping_rate'] : false;
        $data['module_ps_seo_pack_shipping_rates'] = isset($config['module_ps_seo_pack_shipping_rates']) ? (array) $config['module_ps_seo_pack_shipping_rates'] : [];
        $data['module_ps_seo_pack_sdm'] = isset($config['module_ps_seo_pack_sdm']) ? (bool) $config['module_ps_seo_pack_sdm'] : false;
        $data['module_ps_seo_pack_dublin_core'] = isset($config['module_ps_seo_pack_dublin_core']) ? (bool) $config['module_ps_seo_pack_dublin_core'] : false;
        $data['module_ps_seo_pack_open_graph'] = isset($config['module_ps_seo_pack_open_graph']) ? (bool) $config['module_ps_seo_pack_open_graph'] : false;
        $data['module_ps_seo_pack_twitter'] = isset($config['module_ps_seo_pack_twitter']) ? (bool) $config['module_ps_seo_pack_twitter'] : false;
        ...
        $data['module_ps_seo_pack_item_condition'] = isset($config['module_ps_seo_pack_item_condition']) ? (bool) $config['module_ps_seo_pack_item_condition'] : false;
